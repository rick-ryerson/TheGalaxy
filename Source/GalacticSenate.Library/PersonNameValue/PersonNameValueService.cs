...
namespace GalacticSenate.Library.PersonNameValue
{
    ...
    public class PersonNameValueService : IPersonNameValueService
    {
        ...
        public PersonNameValueService(IUnitOfWork<DataContext> unitOfWork)
        {
            ...
            this.personNameValueRepository = unitOfWork.GetPersonNameValueRepository() ?? throw new ApplicationException("Couldn't create personNameValue repository");
        }
