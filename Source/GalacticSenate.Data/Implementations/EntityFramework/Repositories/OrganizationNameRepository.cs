...
namespace GalacticSenate.Data.Implementations.EntityFramework.Repositories {
    internal class OrganizationNameRepository : IOrganizationNameRepository {
        ...
        public IEnumerable<OrganizationName> Get(Guid organizationId, DateTime forDate, int pageIndex, int pageSize) {
            return unitOfWork
               .Context
               .OrganizationNames
        ...
        public IEnumerable<OrganizationName> Get(Guid organizationId, int pageIndex, int pageSize) {
            return unitOfWork
               .Context
               .OrganizationNames
