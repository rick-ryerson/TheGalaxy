...
namespace GalacticSenate.Data.Implementations.EntityFramework {
    internal class UnitOfWork : IUnitOfWork<DataContext>, IDisposable {
        ...
        public IInformalOrganizationRepository GetInformalOrganizationRepository() {
            return new InformalOrganizationRepository(this);
        }
        public IFamilyRepository GetFamilyRepository() {
            return new FamilyRepository(this);
        }
