...
namespace GalacticSenate.Data.Implementations.EntityFramework {
    public class DataContext : DbContext {
        ...
        public DbSet<InformalOrganization> InformalOrganizations { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            BuildInformalOrganizations(modelBuilder);
        ...
        private void BuildInformalOrganizations(ModelBuilder modelBuilder) {
            modelBuilder.Entity<InformalOrganization>()
                .HasKey(p => p.Id);
        }
        private void BuildFamilies(ModelBuilder modelBuilder) {
