...
namespace GalacticSenate.Data.Migrations
{
    ...
    [Migration("20250119234557_AddedFamilies")]
    partial class AddedFamilies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GalacticSenate.Domain.Model.Family", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("InformalOrganizationId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("InformalOrganizationId");
            ...
            modelBuilder.Entity("GalacticSenate.Domain.Model.InformalOrganization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InformalOrganizations");
                });
            ...
            modelBuilder.Entity("GalacticSenate.Domain.Model.PartyRoleType", b =>
                {
                    ...
                    b.ToTable("PartyRoleTypes", (string)null);
                });

            modelBuilder.Entity("GalacticSenate.Domain.Model.Family", b =>
                {
                    b.HasOne("GalacticSenate.Domain.Model.InformalOrganization", "InformalOrganization")
                        .WithMany()
                        .HasForeignKey("InformalOrganizationId");

                    b.Navigation("InformalOrganization");
                });
